...
{/* <div classNameName="max-w-6xl pb-10 px-4 sm:px-6 lg:px-8 md:pb-20 mx-auto">
      <div classNameName="footer-widget-bg">
        <div classNameName="max-w-xl relative z-10 text-center mx-auto">
          <div classNameName="mb-5">
            <h2 classNameName="text-2xl font-bold md:text-3xl dark:text-white">Subscribe</h2>
            <p classNameName="mt-3 text-gray-500 dark:text-neutral-400">Get all the latest Preline updates and news.</p>
          </div>

          <div id="mc_embed_signup">
            <form action="https://praline.us10.list-manage.com/subscribe/post?u=eddd28397383718c2f15e15c2&amp;id=b97f8fe839" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" classNameName="validate" target="_blank" novalidate="novalidate">
              <div id="mc_embed_signup_scroll">
                <div classNameName="grid sm:flex gap-3">
                  <input type="email" value="" name="EMAIL" id="mce-EMAIL" classNameName="block px-4 w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 dark:placeholder:text-neutral-400" placeholder="Email address"/>
                  <input type="submit" name="subscribe" id="mc-embedded-subscribe" classNameName="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                </div>

                <div id="mce-responses" classNameName="mt-3 text-gray-500 dark:text-neutral-400">
                  <div classNameName="response" id="mce-error-response" style={{display:'none'}}></div>
                  <div classNameName="response" id="mce-success-response" style={{display:'none'}}></div>
                </div>

        <div style={{position: 'absolute', left:' -5000px'}} aria-hidden="true">
                    <input type="text" name="b_eddd28397383718c2f15e15c2_b97f8fe839" tabindex="-1" value="" /></div>
              </div>
            </form>
          </div>
        </div>
...
<footer className="dark:bg-gradient-to-t dark:from-blue-900/10 dark:to-transparent py-10">
    <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
      <div className="pb-10">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mb-10">
          <div className="col-span-full lg:col-span-1">
            <a className="flex-none inline-block" href="../index.html">
          ...
          <div>
            ...
            {/* <div className="mt-3 grid space-y-3 text-sm">
              ...
              <p><button type="button" className="text-gray-500 hover:text-gray-900 dark:hover:text-neutral-300" onclick="$crisp.push(['do', 'chat:open'])">Hire Us</button></p>
            </div> */}
          </div>
          ...
          <div>
            ...
            <div className="mt-3 grid space-y-3 text-sm">
              <p><a className="text-gray-500 hover:text-gray-90 dark:hover:text-neutral-300" href="../terms.html">Terms &amp; Conditions</a></p>
              <p><a className="text-gray-500 hover:text-gray-90 dark:hover:text-neutral-300" href="../privacy.html">Privacy Policy</a></p>
              <p><a className="text-gray-500 hover:text-gray-90 dark:hover:text-neutral-300" href="../license.html">License</a></p>
            </div>
          </div>

          <div>
            <h4 className="font-semibold text-gray-800 dark:text-neutral-200">Resources</h4>

            <div className="mt-3 grid space-y-3 text-sm">
              <p><a className="text-gray-500 hover:text-gray-900 dark:hover:text-neutral-300" href="../examples.html">Examples</a></p>
              <p><a className="text-gray-500 hover:text-gray-900 dark:hover:text-neutral-300" href="../figma.html">Figma</a></p>
              <p><a className="text-gray-500 hover:text-gray-900 dark:hover:text-neutral-300" href="../docs/resources.html">Resources</a></p>
            </div>
          </div>
        </div>
